...
(function($){
	...
	$.youtube_video = function(el, options){
		...
		base.create_playlist = function(through_pagination, items, count) {
			...
			for(base.info.playlist_i; base.info.playlist_i < base.playlist_count+count; base.info.playlist_i++) {
				...
				// Vertical video
				// var $video = $('<div class="yesp-playlist-video" data-playing="0" data-index="'+base.info.playlist_i+'"><img src="'+img_src+'" width="200" /><div class="yesp-playlist-overlay"><div class="yesp-playlist-title">'+video.snippet.title+'</div><div class="yesp-playlist-channel">'+video.snippet.channelTitle+'</div></div><div class="yesp-playlist-current"><i class="yesp-icon yesp-icon-play"></i><span>'+base.options.now_playing_text+'</span></div><span class="title_yout_v">'+video.snippet.title+'</span></div>');
			    var $video = $('<div class="yesp-playlist-video" data-playing="0" data-index="'+base.info.playlist_i+'"><img src="'+img_src+'" width="200" /><div class="yesp-playlist-current"><i class="yesp-icon yesp-icon-play"></i><span>'+base.options.now_playing_text+'</span></div><span class="title_yout_v">'+video.snippet.title+'</span></div>');
		...
		base.create_player_element = function() {
			base.$el.css('width', '100%').addClass('yesp').html('<div class="yesp-container"><div class="yesp-autoposter"><div class="yesp-autoposter-icon"><div></div></div></div><div class="yesp-video-container"><div class="yesp-video" id="'+base.id+'_yt"></div><div class="yesp-error"></div></div></div><div class="yesp-playlist"><div class="yesp-next-page"><i class="yesp-icon yesp-icon-plus"></i>Afficher plus</div></div><div class="yesp-hp"><div class="yesp-hp-videos"><div class="yesp-hp-next-page"><i class="yesp-icon yesp-icon-plus"></i></div></div></div>');
	...
	$.youtube_video.defaultOptions = {
		...
		load_more_text: 			'Afficher plus', 		// NEW IN 1.1
